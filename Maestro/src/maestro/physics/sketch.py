...
def _infer_interactions(prompt: str, entities: list[PhysEntity]) -> list[PhysInteraction]:
    ...
    if any(k in low for k in ("hit", "crash", "collide", "撞", "碰")):
