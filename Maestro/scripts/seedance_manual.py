...
# 会走捷径把 A 原地变形成 B。
BRIDGE_34 = ("转场运镜,一镜到底:镜头以人物之间的位置为轴,原地平稳"
             "旋转——从少女含泪的面部特写转开,她随旋转移出画面;画面"
             "短暂掠过舞厅的吊灯光斑与虚化宾客;旋转到她对面时,银发女子"
             "挽着黑金军装男子手臂的中近景进入画面,构图对齐后停稳。"
             "人物只随镜头旋转出入画,绝不在原地变换面貌或服装;全程"
             "同一空间与烛光,无剪辑感。")
BRIDGE_45 = ("转场运镜,一镜到底:镜头从挽臂而立的一对男女平稳横移离开,"
             "二人移出画面;镜头带着位移感穿过舞厅,吊灯光斑与两侧宾客"
             "剪影依次向后掠过;移动到人群边缘减速,两名并肩的深蓝镶金"
             "军装年轻军官进入画面,收为双人中近景停稳。人物只随镜头"
             "移动出入画,绝不在原地变换面貌或服装;全程同一空间与烛光,"
             "无剪辑感。")
BRIDGE_67 = ("转场运镜,一镜到底:镜头从两名并肩军官平稳滑移离开,二人"
             "移出画面;镜头穿过虚化的裙摆与人影,继续移动并轻微推进;"
             "尽头处,以黑色蕾丝折扇半遮下半张脸的女子进入画面,收紧为"
             "她的下半脸特写停稳。人物只随镜头移动出入画,绝不在原地"
             "变换面貌或服装;全程同一空间与光线,无剪辑感。")
